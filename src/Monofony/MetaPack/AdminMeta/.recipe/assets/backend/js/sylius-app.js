...
import 'sylius/ui/js/sylius-bulk-action-require-confirmation';
import 'sylius/ui/js/sylius-form-collection';
import 'sylius/ui/js/sylius-require-confirmation';
import 'sylius/ui/js/sylius-toggle';
import 'sylius/ui/js/sylius-check-all';
